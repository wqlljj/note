package com.example.wangqi.mvvm.model;
...
//    @POST("/api/v1/face/add")
    @POST("/api/face/add")
    Call<FaceResponse> upLoadPicture(@PartMap Map<String, RequestBody> params, @Part MultipartBody.Part part);
    @Multipart
//    @POST("/api/v1/face/remove")
    @POST("/api/face/remove")
    Call<FaceResponse> deletePicture(@PartMap Map<String, RequestBody> params);
//    @Multipart
