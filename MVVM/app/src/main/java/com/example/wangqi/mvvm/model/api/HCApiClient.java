package com.example.wangqi.mvvm.model.api;
...
import com.example.wangqi.mvvm.model.http.ChangePwdHttp;
import com.example.wangqi.mvvm.model.http.ForgetPasswordHttp;
import com.example.wangqi.mvvm.model.http.GetUserInfoHttp;
import com.example.wangqi.mvvm.model.http.HCBaseHttp;
import com.example.wangqi.mvvm.model.http.HCHttpEngine;
import com.example.wangqi.mvvm.model.http.HCHttpFace;
import com.example.wangqi.mvvm.model.http.HCHttpRegister;
import com.example.wangqi.mvvm.model.http.HCHttpUnRegister;
import com.example.wangqi.mvvm.model.http.HCHttprecognizer;
import com.example.wangqi.mvvm.model.http.UpdateUserInfoHttp;
import com.example.wangqi.mvvm.model.http.VerificationCodeHttp;
...
public class HCApiClient {
    ...
    public static  void addFace(String name, String imagefile, final HCBaseHttp.CallBack<FaceResponse> callBack){
        HCHttpEngine.startReq(new HCHttpFace(imagefile,name), CloudServiceContants.FACEHTTP,getCallback(callBack));

    }
    public static  void deleteFace(String face_id, final HCBaseHttp.CallBack<FaceResponse> callBack){
        HCHttpEngine.startReq(new HCHttpFace(face_id), CloudServiceContants.FACEHTTP,getCallback(callBack));

    }
    public static  void getFaceList( final HCBaseHttp.CallBack<FaceResponse> callBack){
    ...
    public static  void register(String userName, String pwd, String phoneID, HCBaseHttp.CallBack<Response> callBack){
        HCHttpEngine.startReq(new HCHttpRegister(userName,pwd,phoneID), CloudServiceContants.BASEURL,getCallback(callBack));
    }
    public static  void unRegister(String userName, String pwd, String phoneID, HCBaseHttp.CallBack<Response> callBack){
        HCHttpEngine.startReq(new HCHttpUnRegister(userName,pwd,phoneID), CloudServiceContants.BASEURL,getCallback(callBack));
    }
    public static  void changePwd(String userName, String oldPwd, String newPwd, HCBaseHttp.CallBack<Response> callBack){
        HCHttpEngine.startReq(new ChangePwdHttp(userName,oldPwd,newPwd), CloudServiceContants.BASEURL,getCallback(callBack));
    }
    public static  void getVerificationCode(String userName, HCBaseHttp.CallBack<Response> callBack){
        HCHttpEngine.startReq(new VerificationCodeHttp(userName), CloudServiceContants.BASEURL,getCallback(callBack));
    }
    public static  void forgetPassword(String userName, String verifiCode, String newPwd, HCBaseHttp.CallBack<Response> callBack){
