...
public class CenterLayout extends ViewGroup {
  ...
  private String TAG="CenterLayout";
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    Log.e(TAG, "onLayout: 1  "+count+"  "+mWidth+"  "+mHeight);
    for (int i = 0; i < count; i++) {
      View child = getChildAt(i);
      if (child.getVisibility() != GONE) {
        CenterLayout.LayoutParams lp = (CenterLayout.LayoutParams) child.getLayoutParams();
        ...
        Log.e(TAG, "onLayout: " +lp.height);
//        if (lp.height > 0)
//          childTop += (int) ((mHeight - lp.height) / 2.0);
//        else
//          childTop += (int) ((mHeight - child.getMeasuredHeight()) / 2.0);
//        Log.e(TAG, "onLayout: 2  "+childLeft+"  "+childTop+"  "+(childLeft + child.getMeasuredWidth())+"  "+(childTop + child.getMeasuredHeight())+"   "+mPaddingTop+"   " +lp.y);
