...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        android.util.Log.e(TAG, "surfaceChanged: "+w+"   "+h );
        mSurfaceWidth = w;
      mSurfaceHeight = h;
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      android.util.Log.e(TAG, "onMeasure: 1  "+mVideoWidth+"  "+mVideoHeight );
...
//      if(false){
          ...
          android.util.Log.e(TAG, "onPrepared: "+mParentWidth+"   "+mParentHeight );
          if(mParentWidth<=0) {
              width = getDefaultSize(mParentWidth, widthMeasureSpec);
              height = getDefaultSize(mParentHeight, heightMeasureSpec);
          }else{
              double p = 1.0 * mParentWidth / mParentHeight;
              double v = 1.0 * mVideoWidth / mVideoHeight;
              if(p>v){
                  height=mParentHeight;
                  width= (int) (mVideoWidth*(1.0*mParentHeight/mVideoHeight));
              }else{
                  width=mParentWidth;
                  height=(int)(mVideoHeight*(1.0*mParentWidth/mVideoWidth));
              }
          }
              android.util.Log.e(TAG, "onMeasure: 2   "+width+"  "+height );
      }else {
           width = getDefaultSize(mVideoWidth, widthMeasureSpec);
           height = getDefaultSize(mVideoHeight, heightMeasureSpec);
          android.util.Log.e(TAG, "onMeasure: 3   " + width + "  " + height);
      }
...
//    mVideoLayout = layout;
  ...
  public void setLooping(boolean flag){
      android.util.Log.e(TAG, "setLooping:  isLoop = "+flag );
      isLoop = flag;
  }
...
//      return;
    ...
    mContext.sendBroadcast(i);
		...
		try {
            ...
            android.util.Log.e(TAG, "openVideo: isLoop = "+isLoop );
