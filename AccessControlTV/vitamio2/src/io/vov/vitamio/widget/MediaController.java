...
//      mWindow.setHeight(LayoutParams.MATCH_PARENT);
      android.util.Log.e(TAG, "setAnchorView: "+mAnchor.getWidth()+"  "+ mAnchor.getHeight());
  ...
  public void show(int timeout) {
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        ...
        setWindowLayoutType();
        android.util.Log.e(TAG, "show: "+mAnchor+"  "+ anchorRect.left+"  "+anchorRect.bottom+
        "  "+mAnchor.getX()+"   "+mAnchor.getY()+"  "+mAnchor.getWidth()+"   "+mAnchor.getHeight());
        mWindow.setWidth(mAnchor.getWidth());
        mWindow.setHeight(mAnchor.getHeight());
        mWindow.showAtLocation(mAnchor, Gravity.START|Gravity.TOP, anchorRect.left, anchorRect.top);
      }
      mShowing = true;
