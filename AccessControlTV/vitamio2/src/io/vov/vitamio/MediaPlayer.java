...
public class MediaPlayer {
  ...
  private static  boolean load_lib(String path, String name){
    android.util.Log.e("TEST", "load_lib: "+path+"  "+name );
    if(path==""){
//		  System.load(name);
  ...
  static {
    ...
    load_lib(  LIB_ROOT ,  "stlport_shared");
    load_lib(  LIB_ROOT ,  "vplayer");
  ...
  private class EventHandler extends Handler {
    ...
    private void onInfo(Message msg) {
        ...
        if (mOnInfoListener != null) {
          android.util.Log.e("TEST", "onInfo: 2" );
    ...
    private void onBufferingUpdate(Message msg) {
        ...
        if (percent >= 100 && mInBuffering) {
            ...
            if (mOnInfoListener != null) {
              ...
              android.util.Log.e("TEST", "onBufferingUpdate: 1" );
...
//        //Log.i("MiuiVideo: get message after player released, msg type: " + msg.what);
      ...
      switch (msg.what) {
        ...
        case MEDIA_INFO:
          ...
          if (mOnInfoListener != null) {
            android.util.Log.e("TEST", "handleMessage: 2" );
            mOnInfoListener.onInfo(mMediaPlayer, msg.arg1, msg.arg2);
          }
          return;
        case MEDIA_CACHE:
