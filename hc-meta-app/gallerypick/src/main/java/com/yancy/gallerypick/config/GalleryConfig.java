...
import com.yancy.gallerypick.loader.FrescoImageLoader;
import com.yancy.gallerypick.loader.GlideImageLoader;
import com.yancy.gallerypick.loader.PicassoImageLoader;
...
public class GalleryConfig {
    public static final int GLIDEIMAGELOADER=0;
    public static final int PICASSOIMAGELOADER=1;
    public static final int FRESCOIMAGELOADER=2;
    ...
    public static class Builder implements Serializable {
        ...
        public Builder useGlideImageLoader() {
            this.imageLoader = new GlideImageLoader();
            return this;
        }
        public Builder usePicassoImageLoader() {
            this.imageLoader = new PicassoImageLoader();
            return this;
        }
        public Builder useFrescoImageLoader(Context mContext) {
            this.imageLoader = new FrescoImageLoader(mContext);
            return this;
        }
