...
public class VideoCapturerAndroid implements
  ...
  private void startPreviewOnCameraThread(int width, int height, int framerate) {
    ...
    final CaptureFormat.FramerateRange fpsRange =
      ...
      Logging.d(TAG, "Available fps ranges: " + fpsRange);
  ...
  private int getFrameOrientation() {
    int rotation = 90;//getDeviceOrientation();
  ...
  public void onPreviewFrame(byte[] data, android.hardware.Camera callbackCamera) {
    ...
    if (isTakePicture && mPictureCallBack!=null){
      mPictureCallBack.onPictureTaken(data, captureFormat.width, captureFormat.height,
              getFrameOrientation(), captureTimeNs);
      isTakePicture = false;
    }
