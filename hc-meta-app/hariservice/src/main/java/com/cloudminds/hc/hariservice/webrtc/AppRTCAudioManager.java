...
public class AppRTCAudioManager {
  private static final String TAG = "smartAudioManager";
...
//    if(PreferenceUtils.getPrefBoolean(BaseConstants.MODE, true)){
...
//    }
  ...
  public void setAudioDevice(AudioDevice device) {
    ...
    switch (device) {
      case SPEAKER_PHONE:
    	if(PreferenceUtils.getPrefBoolean(BaseConstants.SPEAKPHONE, true)){
        ...
        break;
      case EARPIECE:
        Log.i(TAG, "Select  audio device EARPIECE");
        setSpeakerphoneOn(false);
      ...
      public void onReceive(Context context, Intent intent) {
        ...
        switch (state) {
          case STATE_UNPLUGGED:
            Log.d(TAG, "STATE_UNPLUGGED");
                    updateAudioDeviceState(hasWiredHeadset);
            break;
          case STATE_PLUGGED:
            Log.d(TAG, "STATE_PLUGGED");
