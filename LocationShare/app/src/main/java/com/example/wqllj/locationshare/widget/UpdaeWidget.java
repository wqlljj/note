...
//            remoteViews.setOnClickPendingIntent(R.id.widget_refresh, pendingIntent);
             ...
             */
//            remoteViews.setImageViewResource(R.id.tv1, R.drawable.ss_bg);
...
//            Intent topicIntent = new Intent(WidgetAction.GOD_GRID);
//            if(Build.VERSION.SDK_INT>=28) {
//                topicIntent.setComponent(new ComponentName(context, MyAppWidgetProvider.class));//必须写
//            }
//            PendingIntent pendingIntentActivity = PendingIntent.getBroadcast(context, 0, topicIntent, PendingIntent.FLAG_UPDATE_CURRENT);


            remoteViews.setOnClickPendingIntent(R.id.tv1, pendingIntentActivity);
