        ...
        locationListener = new BDLocationListener() {
            ...
            public void onReceiveLocation(BDLocation bdLocation) {
                ...
                if(FootPrintDetailActivity.this.bdLocation==null){
                    ...
                    PersonBean personBean = DbManager.getInstance().getOperator(PersonOperator.class)
                            .queryByKey(personId);
                    List<RouteLineBean> routeLineBeen = DbManager.getInstance().getOperator(RouteLineOperator.class)
                            .queryRouteLineByDate(start, end);
